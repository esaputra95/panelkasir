...
import { SaleStockistSearchInterface, SaleStockistInterface } from "../../../interfaces/sales/SaleStockistInterface";
import { AxiosError } from "axios";

interface ParamSaleStockistInterface extends SaleStockistSearchInterface {
	page?: number,
	limit?: number,
	order?: string
}

const getData = async (url:string, params:ParamSaleStockistInterface) => {
	try {
...
const postData = async (url:string, data:SaleStockistInterface) => {
	try {
		if(data.id){
