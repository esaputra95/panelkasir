...
import { AgenTypeSearchInterface, AgenTypeInterface } from "../../../interfaces/masters/agenTypeInterface";
import { AxiosError } from "axios";

interface ParamAgenTypeInterface extends AgenTypeSearchInterface {
	page?: number,
	limit?: number,
	order?: string
}

const getData = async (url:string, params:ParamAgenTypeInterface) => {
	try {
...
const postData = async (url:string, data:AgenTypeInterface) => {
	try {
		if(data.id){
