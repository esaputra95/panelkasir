...
import { MemberSearchInterface, MemberInterface } from "../../../interfaces/masters//MemberInterface";
import { AxiosError } from "axios";

interface ParamMemberInterface extends MemberSearchInterface {
	page?: number,
	limit?: number,
	order?: string
}

const getData = async (url:string, params:ParamMemberInterface) => {
	try {
...
const postData = async (url:string, data:MemberInterface) => {
	try {
		if(data.id){
