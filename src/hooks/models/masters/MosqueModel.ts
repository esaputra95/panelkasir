...
import { MosqueSearchInterface } from "../../../interfaces/masters/MosqueInterface";
import { AxiosError } from "axios";

interface ParamMosqueInterface extends MosqueSearchInterface {
	page?: number,
	limit?: number,
	order?: string
}

const getData = async (url:string, params:ParamMosqueInterface) => {
	try {
