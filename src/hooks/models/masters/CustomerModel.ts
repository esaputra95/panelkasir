...
import { CustomerSearchInterface } from "../../../interfaces/masters/CustomerInterface";
import { AxiosError } from "axios";

interface ParamCustomerInterface extends CustomerSearchInterface {
	page?: number,
	limit?: number,
	order?: string
}

const getData = async (url:string, params:ParamCustomerInterface) => {
	try {
