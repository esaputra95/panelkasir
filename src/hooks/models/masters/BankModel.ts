...
import { BankSearchInterface } from "../../../interfaces/masters/BankInterface";
import { AxiosError } from "axios";

interface ParamBankInterface extends BankSearchInterface {
	page?: number,
	limit?: number,
	order?: string
}

const getData = async (url:string, params:ParamBankInterface) => {
	try {
