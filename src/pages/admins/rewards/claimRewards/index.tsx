...
import { useClaimRewards } from '../../../../hooks/fetch/rewards/useClaimRewards'
import ModalForm from '../../../../components/ui/modal/ModalForm'
import FormClaimRewards from './form'
        ...
        <div className='w-full'>
            ...
            >
                <FormClaimRewards
                    ...
                    status={status}
                    watch={watch}
                    checkTotalPoint={checkTotalPoint}
                    register={register}
                    fields={fields}
                />
            </ModalForm>
            <div className='w-full'>
                ...
                <Table
                    data={dataClaimRewards?.data?.ClaimRewards ?? []}
                    ...
                    onUpdate={onUpdate}
                    onDetail={onDetail}
                    downloadClaimReward={downloadClaimReward}
                />
                <TablePaging
                    page={page.page}
                    total={page.total}
