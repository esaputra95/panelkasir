...
import { usePaymentMethod } from '../../../../hooks/slices/settings/usePaymentMethod'
        ...
        <div className='w-full flex p-2 bg-white'>
            ...
            <div className='w-full overflow-auto'>
                <div className='py-4 flex justify-between'>
                    {
                        (PaymentMethod?.level === "admin" || PaymentMethod?.level === "superadmin") ? (
                            <Button 
                ...
                <Table
                    data={dataPaymentMethod?.data?.PaymentMethod ?? []}
