                ...
                <ul className="inline-flex -space-x-px text-sm">
                    ...
                    </li>
                    {
                        page > 19 ? (
                            <>
                                <li key={Math.random().toString(5)}>
                                    <span className={`bg-white hover:cursor-pointer flex items-center justify-center px-3 h-8 leading-tight text-gray-500 border border-gray-300 hover:bg-gray-200 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white`} >
                                        .
                                    </span>
                                </li>
                                <li key={Math.random().toString(5)}>
