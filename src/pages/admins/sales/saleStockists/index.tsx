...
import { useSaleStockist } from '../../../../hooks/fetch/sales/saleStockist/useSale'
    ...
    return (
        <div className='w-full'>
            ...
            <div className='w-full'>
                ...
                <Table
                    data={dataSaleStockist?.data?.SaleStockist ?? []}
...
export default SaleStockistPage