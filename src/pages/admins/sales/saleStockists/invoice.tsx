...
import useInvoice from '../../../../hooks/fetch/sales/saleStockist/useInvoice';
                    ...
                    <View style={styles.section}>
                        <View style={{flexDirection:'row', justifyContent:'space-between'}}>
                            <View style={{flexDirection:'row'}}>
                                <Image 
                                    ...
                                    src='https://media.istockphoto.com/id/1443562748/id/foto/kucing-jahe-lucu.jpg?s=612x612&w=0&k=20&c=g--RaRzUgk83osyJGx88ZtoChTk3VzP8n86EQHvc7Ko=' 
                                />
                        ...
                        <View style={{marginTop: 4}}>
                            <Table style={styles.styleTd}>
                                ...
                                {
                                    data?.SaleStockistDetails.map((value, index)=> (
                                        <TR key={value.id}>
