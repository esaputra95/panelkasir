...
import { useClaimPoints } from '../../../../hooks/fetch/points/useClaimPoints'
import ModalForm from '../../../../components/ui/modal/ModalForm'
import FormClaimPoints from './form'
    ...
    return (
        <div className='w-full'>
            ...
            <div className='w-full'>
                ...
                <Table
                    data={dataClaimPoints?.data?.ClaimPoints ?? []}
                    isFetching={isFetching}
                    page={page.page}
                    limit={page.limit}
                    onDelete={onDelete}
                    downloadClaimPoints={downloadClaimPoints}
                />
                <TablePaging
                    page={page.page}
                    total={page.total}
