...
import { ClaimPointsInterface } from "../../../../interfaces/points/ClaimPointsInterface";
import moment from "moment";

type TableProps = {
    data?: ClaimPointsInterface[],
    isFetching?: boolean,
    page: number,
    limit: number,
    onDelete:(id:number)=>void;
    downloadClaimPoints: (id: number) => Promise<void>
}
                            ...
                            <tr key={value.id} className="overflow-auto bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td className="px-6 py-4 flex">
                                    <span
                                        ...
                                        onClick={()=>downloadClaimPoints(value.id ?? 0)}
                                    >
